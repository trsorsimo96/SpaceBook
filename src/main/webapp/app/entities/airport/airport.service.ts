...
export class AirportService {
    ...
    private resourceUrl =  SERVER_API_URL + 'api/airports';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/airports';
    ...
    search(req?: any): Observable<HttpResponse<Airport[]>> {
        const options = createRequestOption(req);
        return this.http.get<Airport[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Airport[]>) => this.convertArrayResponse(res));
    }
