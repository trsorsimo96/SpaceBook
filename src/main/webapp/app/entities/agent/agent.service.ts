...
export class AgentService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/agents';
    ...
    search(req?: any): Observable<HttpResponse<Agent[]>> {
        const options = createRequestOption(req);
        return this.http.get<Agent[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Agent[]>) => this.convertArrayResponse(res));
    }
