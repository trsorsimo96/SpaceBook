...
public class Airport implements Serializable {
    ...
    public Airport origin(Segment segment) {
        this.origin = segment;
        return this;
    }

    public void setOrigin(Segment segment) {
        this.origin = segment;
    }
    ...
    public Airport destination(Segment segment) {
    ...
    public Town getAirport() {
        return airport;
    }

    public Airport airport(Town town) {
        this.airport = town;
        return this;
    }

    public void setAirport(Town town) {
        this.airport = town;
    }
