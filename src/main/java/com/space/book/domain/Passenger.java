...
public class Passenger implements Serializable {
    ...
    public Booking getPassengers() {
        return passengers;
    }

    public Passenger passengers(Booking booking) {
        this.passengers = booking;
        return this;
    }

    public void setPassengers(Booking booking) {
        this.passengers = booking;
    }
