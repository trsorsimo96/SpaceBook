...
import { PassengerDialogComponent } from '../../../../../../main/webapp/app/entities/passenger/passenger-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Passenger Management Dialog Component', () => {
        let comp: PassengerDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PassengerDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'passengerListModification', content: 'OK'});
