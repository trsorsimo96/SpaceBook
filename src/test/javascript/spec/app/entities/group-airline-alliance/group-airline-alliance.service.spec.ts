...
describe('Service Tests', () => {
    ...
    describe('GroupAirlineAlliance Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GroupAirlineAllianceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/group-airline-alliances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GroupAirlineAlliance', () => {
